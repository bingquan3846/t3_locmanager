<?php
	...
	***************************************************************/
	/**
	* t3_locmanager module cm1
	* This class holds some functions used in the TYPO3 backend for exporting and re-importing localizable data
	* $Id$
	* @author Daniel Zielinski <d.zielinski@l10ntech.de>
	*/


	//$TODO.="TODO: Activate CE type check <br/>";
	//$TODO.="TODO: <br/>";
	...
	class tx_t3locmanager_cm1 extends t3lib_SCbase {
		/**
		 ...
		 *
		 * @return	string		$content Content of module
		 */
		function main() {
			global $BE_USER, $LANG, $BACK_PATH, $TCA_DESCR, $TCA, $CLIENT, $TYPO3_CONF_VARS; //$SOBE; //TODO:obsolete?
			...
			switch((string)$this->MOD_SETTINGS['function']) {
				...
				if ($params['submit'] == 1) {
					...
					if (is_uploaded_file($_FILES['loc']['tmp_name'])) {
						...
						// delete files from downloads if import success
						// print report
					} else {
	...
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3_locmanager/cm1/index.php']) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3_locmanager/cm1/index.php']);
	}

	// Make instance:
	$SOBE = t3lib_div::makeInstance('tx_t3locmanager_cm1');
	$SOBE->init();
